    ...
    return (
        < div ref={fbConRef} className="w-screen h-dvh p-2 overflow-hidden" >
            <div className='w-full relative overflow-hidden rounded-4xl'>
                ...
                <h1 className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[10vw] font-bold text-[#f4efe7]'>KARNAN<sub className='text-[5vw]'>SP</sub></h1>
                <div className='absolute bottom-5 px-4 w-full'>
                    <div className="w-full h-auto flex md:flex-row flex-col md:justify-between md:items-end">
                        ...
                        <p
                            ...
                            style={{ textShadow: '2px 2px 4px #000' }}
                        >
                            Full Stack Engineer building production systems with MERN, Django, FastAPI, and AI platforms.
                        </p>
                    </div>
                </div>
            </div>
