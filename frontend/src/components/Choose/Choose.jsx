...
const Choose = () => {
    ...
    return (
        <section className="choose-section w-full h-dvh p-8 pt-10">
            <p className='text-[.7rem] text-[#eae5dd] choose-subtitle'>Featured Tech Stack</p>
            ...
            <div className="choose-sec w-full flex lg:flex-row flex-col justify-center items-start gap-10 lg:mt-0">
                <div className='lg:w-1/2 w-full text-[#b1a696] lg:text-[2rem] text-[1rem] md:leading-[1.1] lg:mt-0 mt-8 lg:pr-16'>
                    <p>I specialize in MERN stack for full-stack development, Django/FastAPI for backend services, and modern cloud infrastructure. Each project combines best practices in code quality, performance optimization, and production-grade deployment.</p>
                </div>
                <div className='lg:w-1/2 w-full'>
                    <div className=" lg:w-[30%] w-[60%]">
                        <p className="text-[.7rem] text-[#eae5dd]">My projects are built on:</p>
                    </div>
