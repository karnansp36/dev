                    ...
                    <div className="col-content">
                        <div className="col-content-wrapper">
                            ...
                            <div className="col-content-para flex items-center gap-4 justify-between">
                                ...
                                <p className={`text-[12px] font-medium  ${!reveal ? "mr-6" : "mr-0"}`}> Crafted with precision and deployed at scale
                                    <br />
                                    using modern cloud infrastructure and DevOps.
                                </p>
                            </div>
                ...
                <div className="col col-3">
                    <div className="col-content-wrapper">
                        ...
                        <div className={`col-content-para flex items-center gap-4 justify-between ${reveal ? "ml-0" : "ml-6"}`}>
                            ...
                            <p className="text-[12px] font-medium"> Crafted with precision and deployed at scale
                                <br />
                                using modern cloud infrastructure and DevOps.
                            </p>
                        </div>
                    ...
                    <div className="col-content-wrapper-2">
                        ...
                        <div className="col-content-para flex items-center gap-4 justify-between">
                            ...
                            <p className={`text-[12px] font-medium  ${!reveal ? "mr-0" : "mr-6"}`}> Crafted with precision and deployed at scale
                                <br />
                                using modern cloud infrastructure and DevOps.
                            </p>
                        </div>
