...
const Gallery = () => {
    ...
    // Generate repeating text elements
    ...
    return (
        <section className="gallery-page4" ref={pageRef}>
            ...
            <div className="gallery-background">
                <img src={gbg1} alt="Pro Inventory" />
                ...
                <div className="gallery-bottomText">
                    <div className='w-full flex justify-center items-center gap-0'>
                        ...
                        <h3>Multi-tenant SaaS with 4-tier RBAC, real-time analytics, <br /> and seamless payment integration. Production-ready.</h3>
                    </div>
            ...
            <div id="gallery-second" className="gallery-background2">
                ...
                <div className="gallery-bottomText">
                    <div className='w-full flex justify-center items-center gap-0'>
                        <BsFillPlusCircleFill className='w-8 h-8 text-[#b1a696]' />
                        <h3>Multi-model AI platform with RAG, semantic search, <br /> and generative UI. Kubernetes-ready for enterprise deployment.</h3>
                    </div>
                    <div className="relative z-9 w-50 h-[0.1rem] bg-[#4f4b48]">
            ...
            <div id="gallery-third" className="gallery-background2">
                <img src={gbg3} alt="Personal Manager" />
                <div className="gallery-topText">
                ...
                <div className="gallery-bottomText">
                    <div className='w-full flex justify-center items-center gap-0'>
                        <BsFillPlusCircleFill className='w-8 h-8 text-[#b1a696]' />
                        <h3>AI microservice with CrewAI and semantic memory, <br /> WebSocket real-time, and Celery workers. FastAPI powered.</h3>
                    </div>
                    <div className="relative z-9 w-50 h-[0.1rem] bg-[#4f4b48]">
