            ...
            >
                ...
                <div className="relative flex-shrink-0 w-[80vw] h-full overflow-hidden">
                    <div className="w-[77vw] absolute top-10 left-5 flex justify-between items-start text-[#f4efe7]">
                        <h1 className="text-3xl font-bold">MERN Stack<br /> Development</h1>
                        <p className="border-[1px] rounded-3xl px-2 py-1 text-center text-[0.7rem]">React</p>
                    </div>
                    <img
                        src={acImg1}
                        alt="Activity 1"
                    ...
                    <div className="w-[77vw] absolute bottom-10 left-5 flex justify-between items-start ">
                        <p className="text-[0.68rem] font-bold text-[#f4efe7]">Build scalable web applications with React, Node.js, MongoDB,<br />and Express for modern full-stack solutions.</p>
                ...
                <div className="relative flex-shrink-0 w-[80vw] h-full overflow-hidden">
                    <div className="w-[77vw] absolute top-10 left-5 flex justify-between items-start text-[#f4efe7]">
                        <h1 className="text-3xl font-bold">Backend<br />Frameworks</h1>
                        <p className="border-[1px] rounded-3xl px-2 py-1 text-center text-[0.7rem]">Python</p>
                    </div>
                    <img
                        src={acImg2}
                        alt="Activity 1"
                    ...
                    />
                    <div className="w-[77vw] absolute bottom-10 left-5 flex justify-between items-start ">
                        <p className="text-[0.68rem] font-bold text-[#f4efe7]">Create robust APIs with Django and FastAPI, featuring async<br />processing, microservices, and high-performance backends.</p>
                        <div className="flex justify-center items-center">
                ...
                <div className="relative flex-shrink-0 w-[80vw] h-full overflow-hidden">
                    <div className="w-[77vw] absolute top-10 left-5 flex justify-between items-start text-[#f4efe7]">
                        <h1 className="text-3xl font-bold">Cloud &<br /> DevOps</h1>
                        <p className="border-[1px] rounded-3xl px-2 py-1 text-center text-[0.7rem]">AWS</p>
                    </div>
                    <img
                        src={acImg3}
                        alt="Activity 1"
                    ...
                    />
                    <div className="w-[77vw] absolute bottom-10 left-5 flex justify-between items-start ">
                        <p className="text-[0.68rem] font-bold text-[#f4efe7]">Deploy with confidence using Docker, Kubernetes, AWS,<br />and Cloudflare for production-grade infrastructure.</p>
                        <div className="flex justify-center items-center">
