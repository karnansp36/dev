            ...
            <div className="activities-sec w-full flex lg:flex-row flex-col justify-center items-start gap-10 lg:mt-0">
                <div className='lg:w-1/2 w-full'>
                    <div className="lg:w-[30%] w-[60%]">
                        <p className="text-[.7rem] text-[#eae5dd] text-nowrap">My expertise covers different tech stacks:</p>
                    </div>
                ...
                <div className='lg:w-1/2 w-full text-[#b1a696] lg:text-[2rem] text-[1rem] md:leading-[1.1] lg:mt-0 mt-8 lg:pr-0'>
                    <p>Full Stack development with MERN, Django, and FastAPI. Cloud infrastructure using AWS, Docker, and Kubernetes. AI systems with CrewAI, RAG, and semantic memory. Currently shipping multi-tenant SaaS platforms and AI microservices.</p>
                </div>
            </div>
        </section>
    );
